...
switch ($acao) {
    case 'criar':
        ...
        $imagemUrl = $_POST['imagem_produto'] ?? null;
        
        $categoria = $categoria_id ? $categoriaDAO->getById($categoria_id) : null;
        
        $novoProduto = new Produto(null, $nome, $descricao, $preco, $categoria, true, null, null, null, $imagemUrl ? $imagemUrl : null);
    ...
    case 'editar':
        ...
        if ($produtoExistente) {
            $produtoAtualizado = new Produto(
                ...
                $produtoExistente->getDataCriacao(), null, null, $imagemUrl ? $imagemUrl : null
            );
